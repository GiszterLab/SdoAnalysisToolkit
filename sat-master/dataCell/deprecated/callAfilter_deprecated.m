    ...
    case 'notch'
        ...
        for i=1:8
            ...
            try
                ...
                % DSP Toolbox fallback
                Q = 30;
                alpha = sin(wo*pi)/(2*Q); % Note the multiplication by pi for correct normalization
                cos_w0 = cos(wo*pi);
                ...
                % Normalize to keep DC gain at 1 (for notch filters, this is safer than sum(a1))
                b1 = b1 * (1 + alpha) / (1 + alpha + alpha);  % Adjust gain appropriately

                % Duplicate for 4th-order
                b2 = b1;
                a2 = a1;
