%% computeSDO_populateSDOArray (DEPRECIATED)
...
%
% NOTE: This variant of the script is depreciated, which uses the older
% (slower) method of parameters validation, compatible with older versions
% of MATLAB (< 2018). 
%
...
%%
function [sdo] = populateSDOArray_func(xtData, ppData, pxNPoints, varargin)
p = inputParser; 
