...
% Copyright (C) Trevor S. Smith, 2025
%
...
% along with this program.  If not, see <https://www.gnu.org/licenses/>.
  ...
  % // this may need to be a value class instead.
classdef sdoComputer < matlab.mixin.Copyable %< handle & matlab.mixin.Copyable
    properties
      % _____ Data ____ 
      sdoMatrix         = []; % L
    ...
    methods
      ...
      function obj = compute(obj, px0, px1)
          ...
          % PX0/1 contains 3D data of form: [N_XT, N_TR, N_PP]
      ...
      function px1_est = predictPx(obj, px0)
          ...
          sdoPredict = @(x) Ln*x+x; 
          px1_est = copy(px0); 
          px1_dat = cellfun(sdoPredict, px0.data, 'UniformOutput', 0); 
          %
